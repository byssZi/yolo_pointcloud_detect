...
public:
    ...
    PatchWorkpp(ros::NodeHandle *nh) : node_handle_(*nh) {
        ...
        node_handle_.param("czm/num_zones", num_zones_, 4);
        node_handle_.param("czm/num_sectors_each_zone", num_sectors_each_zone_, vector<int>());
        node_handle_.param("czm/num_rings_each_zone", num_rings_each_zone_, vector<int>());
        node_handle_.param("czm/elevation_thresholds", elevation_thr_, vector<double>());
        node_handle_.param("czm/flatness_thresholds", flatness_thr_, vector<double>());
        std::cout<<"num_sectors_each_zone_ = "<<num_sectors_each_zone_.size()<<std::endl;
        std::cout<<"elevation_thresholds = "<<elevation_thr_.size()<<std::endl;
    ...
    std::pair<pcl::PointCloud<PointT>, pcl::PointCloud<PointT>> estimate_ground(pcl::PointCloud<PointT> cloud_in);
...
template<typename PointT> inline
std::pair<pcl::PointCloud<PointT>, pcl::PointCloud<PointT>> PatchWorkpp<PointT>::estimate_ground(
 ...
 */
    ...
    return std::pair<pcl::PointCloud<PointT>, pcl::PointCloud<PointT>>(cloud_nonground, cloud_ground);
}
